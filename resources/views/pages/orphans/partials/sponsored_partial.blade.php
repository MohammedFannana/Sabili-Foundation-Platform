            ...
            @forelse ($orphans as $orphan)
                ...
                <tr>
                    ...
                    <td class="d-flex flex-wrap  gap-1">
                        ...
                        <form action="{{ route('orphans.action.archived', $orphan->id) }}" method="POST" style="display:inline;">
                            @csrf
                            <button type="submit"  class="text-decoration-none mb-1 btn btn-outline-primary">أرشفة</button>
                        </form>
